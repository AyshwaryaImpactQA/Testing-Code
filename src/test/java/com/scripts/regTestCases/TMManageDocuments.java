...
public class TMManageDocuments extends Driver {
	...
	public void configClass() throws Exception {
		...
		excelData.setExcelData("Documents", 1, 6, "AutoDocument"
		...
		reports.startTest("Manage Documents with TM Admin");
	...
	public void addDocument() throws Exception {
		district = excelData.getExcelData("Documents", 1, 4);
		school = excelData.getExcelData("Documents", 1, 5);
		docName = excelData.getExcelData("Documents", 1, 6);
