...
public class DAManageRequisitionNumber extends Driver {
	...
	public void configClass() throws Exception {
		...
		excelData.setExcelData("RequisitionNo", 2, 5, "AutoReqNo"
		...
		reports.startTest("Manage Requisition No with District Admin");
	...
	public void addRequisitionNo() throws Exception {
		userType = excelData.getExcelData("Login", 3, 5);
		district = excelData.getExcelData("RequisitionNo", 2, 4);
		reqNo = excelData.getExcelData("RequisitionNo", 2, 5);
		positionType = excelData.getExcelData("RequisitionNo", 2, 6);
		location = excelData.getExcelData("RequisitionNo", 2, 7);
		positionTitle = excelData.getExcelData("RequisitionNo", 2, 8);
