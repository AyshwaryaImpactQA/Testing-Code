...
public class TMDJobOrdersPL {
	...
	// @FindBy(xpath =
	// "//input[@id='schoolName'][not(contains(@onblur,'lockGeozone(1)'))]")
	...
	@FindBy(xpath = "//table[@id='tblGrid']//tr[1]/td[3]")
	private WebElement titleFirstRow;

	@FindBy(xpath = "//table[@id='tblGrid']//tr[1]/td[1]")
	private WebElement jobIDFirstRow;

	public WebElement getJobIDFirstRow() {
		if (commonLib.isDisplayed(jobIDFirstRow)) {
			return jobIDFirstRow;
		} else {
			return null;
		}
	}
	...
	public WebElement getBtnSaveSection() {
		if (commonLib.isDisplayed(btnSaveSection)) {
	...
	@FindBy(xpath = "//a[contains(@onclick, 'return activateDeactivateJob')]")
	...
	@FindBy(xpath = "//div[@id='duplicateReqModal']//button[text()='Ok ']")
	...
	@FindBy(id = "attachJobAssessment1")
	...
	@FindBy(id = "refno")
	private WebElement txtBoxReference;

	public WebElement getTxtBoxReference() {
		if (commonLib.isDisplayed(txtBoxReference)) {
	...
	private WebElement txtBxKywordSearch;

	public WebElement getTxtBxKywordSearch() {
		if (commonLib.isDisplayed(txtBxKywordSearch)) {
			return txtBxKywordSearch;
		} else {
			return null;
		}
	}

	public WebElement getChkBoxActiveJobsSA() {
		if (commonLib.isDisplayed(chkBoxActiveJobsSA)) {
			return chkBoxActiveJobsSA;
		} else {
			return null;
		}
	}
	...
	@FindBy(id = "activeJobsToSA1")
	private WebElement chkBoxActiveJobsSA;
