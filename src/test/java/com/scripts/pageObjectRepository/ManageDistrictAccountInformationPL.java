...
public class ManageDistrictAccountInformationPL {
	...
	@FindBy(xpath = "//a[text()='+Add Job Order']")
	private WebElement linkAddJobOrder;
	
	@FindBy(name = "ncIntegrated")
	private WebElement chkBoxNCIntegrated;
	
	@FindBy(id = "hrIntegratedId")
	private WebElement radioBtnHRIntegrated;
	
	@FindBy(id = "linqIntegratedId")
	private WebElement radioBtnlinqIntegrated;
	...
	public WebElement getChkBoxNCIntegrated() {
		if (commonLib.isDisplayed(chkBoxNCIntegrated)) {
			return chkBoxNCIntegrated;
		} else {
			return null;
		}
	}

	public WebElement getRadioBtnHRIntegrated() {
		if (commonLib.isDisplayed(radioBtnHRIntegrated)) {
			return radioBtnHRIntegrated;
		} else {
			return null;
		}
	}

	public WebElement getLinkAddJobOrder() {
		if (commonLib.isDisplayed(linkAddJobOrder)) {
			return linkAddJobOrder;
		} else {
			return null;
		}
	}

	public WebElement getRadioBtnlinqIntegrated() {
		if (commonLib.isDisplayed(radioBtnlinqIntegrated)) {
			return radioBtnlinqIntegrated;
		} else {
			return null;
		}
	}
